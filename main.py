...
async def process_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if is_game_active and len(text) == 5 and text.isalpha():
        ...
        # NOTE: Dictionary check has been removed as per user request. 
        # All 5-letter alpha words are now accepted as guesses.
        ...
        # Simple error message for wrong format, no need for "galti ka design"
        await update.message.reply_text(
